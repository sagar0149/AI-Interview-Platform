...
function ResumeBuilder() {
  ...
  const generateAISummary = async () => {
    if (!formData.skills.trim() && !formData.projects.trim()) {
      alert("Please enter your skills or projects first.");
      return;
    }
  ...
  const downloadPDF = async () => {
    ...
    try {
      ...
      link.download = `${formData.name.trim()}_Resume.pdf`;
      ...
      alert(
        "Failed to generate PDF. Please check your backend connection."
      );
    } finally {
      ...
      <style>
        {`
          ...
          @keyframes aiPulse {
            ...
            50% {
              box-shadow: 0 0 35px rgba(34, 211, 238, .25);
            }
          }
      ...
      >
        ...
        >
          <div>
            ...
            >
              Build a professional resume and let AI
              help you create a powerful career summary.
            </p>
          </div>
        ...
        >
          ...
          <div
            className="resume-glass resume-form-card"
            style={{
              background:
